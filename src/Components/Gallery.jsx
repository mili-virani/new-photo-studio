...
const Gallery = () => {
  ...
  const [responseData, setResponseData] = useState(null); // Add state for API response
  ...
  const fetchApiData = async () => {
    try {
      const response = await handleApiCall(); // Call API function from utils/api
  ...
  return (
    <main className="wrapper">
      ...
      <div className="text-container">
        <div className="text-first pe-5 my-4" style={{ paddingLeft: "30px" }}>
